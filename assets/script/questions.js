export const tests = [
	...
	['При работе с разделом "Налоги и взносы" программы "1С:Зарплата и управление персоналом" имеются возможности:',
		...
		4],
	['При работе с разделом "Отчетность, справки" программы "1С:Зарплата и управление персоналом" имеются возможности:',
		'Формировать регламентированную отчетность по налогам и взносам с выплат в пользу работников',
		'Формировать справки 2-НДФЛ и справки для расчета пособий для выдачи сотрудникам',
		'Получать аналитическую отчетность по кадровому учету и расчету зарплаты',
		'Верны все вышеперечисленные варианты',
